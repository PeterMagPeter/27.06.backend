    ...
    return (<react_bootstrap_1.Navbar className="bg-body-tertiary" data-bs-theme="dark">
      <div className={Header_module_css_1.default.headerStack}>
        ...
        <div className={Header_module_css_1.default.profileContainer}>
          <react_bootstrap_1.NavDropdown title={<div>
              <react_bootstrap_1.Image className={Header_module_css_1.default.profileImg} src={profile_pic_placeholder_png_1.default} roundedCircle/>
              <a className={Header_module_css_1.default.nickname}>{nick}</a>
              </div>} id="nav-dropdown" align={"end"}>
            ...
            {guest ? (<react_bootstrap_1.NavDropdown.Item onClick={() => handleLogin()}>
                Login
              </react_bootstrap_1.NavDropdown.Item>) : (<react_bootstrap_1.NavDropdown.Item onClick={handleLogout}>Logout</react_bootstrap_1.NavDropdown.Item>)}
          </react_bootstrap_1.NavDropdown>
        </div>
      </div>
    </react_bootstrap_1.Navbar>);
}
//# sourceMappingURL=HeaderOnlyPicture.js.map