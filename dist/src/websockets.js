...
const Ai_Playtest_1 = require("./gamelogic/Ai_Playtest");
...
function startWebSocketConnection(server) {
    ...
    io.on("connection", (socket) => {
        ...
        socket.on("sendShipPlacement", (body, username) => {
            ...
            const playerBoard = new Board_1.Board(10, 6, username, arr);
            playerBoard.addShips(playerShips);
            //   playerBoard.setShipPositions();
            let aiBoard = new Ai_Playtest_1.Ai_Playtest(playerBoard);
            testee = new GameController_Playtest_1.GameController(playerBoard, aiBoard.aiBoard, socket, "Player");
