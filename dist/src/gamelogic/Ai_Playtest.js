...
class Ai_Playtest {
    constructor(playerBoard, difficulty) {
        ...
        this.aiBoard = new Board_1.Board(10, 6, "Ai", this.initializeBoard(), this.shipsTemp); // müsste aber auch gehen
    ...
    initializeBoard() {
        ...
        logger_1.logger.debug(" init ships " + JSON.stringify(ships));
        return playfield;
