...
class GameController {
    ...
    // }
    constructor(playerBoard, aiBoard, socket, playerWhosTurnItIs, difficulty) {
        this.playerBoard = playerBoard;
        this.aiBoard = aiBoard;
        this.ai = new Ai_Playtest_1.Ai_Playtest(this.playerBoard, "god");
        this.socket = socket;
...
//# sourceMappingURL=GameController_Playtest%20copy.js.map