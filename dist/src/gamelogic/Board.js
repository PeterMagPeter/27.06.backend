...
class Board {
    ...
    ships // die Schiffe die der boardOwner gesetzt hat
        ...
        logger_1.logger.info("constructor ships " + JSON.stringify(ships));
        this.addShips(ships);
        logger_1.logger.info("constructor this.ships keys: " +
            JSON.stringify(Array.from(this.ships.keys())));
        logger_1.logger.info("constructor this.ships values: " +
    ...
    addShips(ships) {
        for (let ship of ships) {
            ...
            logger_1.logger.debug(JSON.stringify(ship.identifier));
        }
        logger_1.logger.debug("-----adships-------");
    }
}
exports.Board = Board;
