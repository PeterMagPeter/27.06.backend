...
function hostOnlineMatch(onlineMatch) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const privCollAsArray = yield db
...
function updateOnlineMatch(onlineMatchResource, username) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            let room = yield privateCollection.findOne({
            ...
            if (!room) {
                ...
                room = yield publicCollection.findOne({
                    roomId: onlineMatchResource.roomId,
                });
                if (room && onlineMatchResource.privateMatch) {
                    yield publicCollection.findOneAndDelete({
                        roomId: onlineMatchResource.roomId,
                    });
                    deleted = true;
                }
                ...
                yield privateCollection.findOneAndDelete({
                    roomId: onlineMatchResource.roomId,
                });
                deleted = true;
            }
...
function deleteOnlineMatch(roomId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            // Search for match
            const privateMatch = yield client
                .db("OceanCombat")
                .collection("PrivateOnlinematches")
                .findOne({ roomId: roomId });
            const publicMatch = yield client
                .db("OceanCombat")
                .collection("PublicOnlinematches")
                .findOne({ roomId: roomId });
